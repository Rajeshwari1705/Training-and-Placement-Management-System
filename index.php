...
<body>
    ...
    <section id="hero-animated" class="hero-animated d-flex align-items-center">
        <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative" data-aos="zoom-out">
            ...
            <h2>Welcome to <span>Sknsits Placement Cell</span></h2>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out">
                        <div class="service-item position-relative">
                            ...
                            <h4><a href="login-candidates.php" class="stretched-link">Login</a></h4>
                            <p>Students can login using their credentials.<a href="login-candidates.php"></a></p>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane active show" id="tab-1">
                        <div class="row gy-4">
                            <div class="col-lg-8 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="100">
                                <h3>Objectives</h3>
                                <p class="fst-itali">
                                    Our SKNSITS-PLACEMENT PORTAL serves various objectives:
                                </p>
                                <ul>
